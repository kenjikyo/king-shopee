...
<head>
	...
	<!-- Custom CSS -->
    <link href="assets/dist/css/style.css?v={{time()}}" rel="stylesheet" type="text/css">
	<!-- Custom CSS -->
    <link href="assets/dist/css/custom.css?v={{time()}}" rel="stylesheet" type="text/css">
    @yield('css')
</head>
...
<body>
    ...
    <div class="wrapper theme-1-active box-layout pimary-color-red">
        <!-- Top Menu Items -->
        @include('System.Layouts.Topbar')
		<!-- /Top Menu Items -->
		
        <!-- Left Sidebar Menu -->
        @include('System.Layouts.Left-Sidebar')
		<!-- /Left Sidebar Menu -->
	...
	<script src="assets/vendors/bower_components/datatables.net-buttons/js/buttons.flash.min.js"></script>
	<script src="assets/vendors/bower_components/jszip/dist/jszip.min.js"></script>
	<script src="assets/vendors/bower_components/pdfmake/build/pdfmake.min.js"></script>
	<script src="assets/vendors/bower_components/pdfmake/build/vfs_fonts.js"></script>
	...
	<script src="assets/dist/js/export-table-data.js?v=1"></script>
	...
	<script>
		$.toast({
			...
			position: 'top-right',
			loaderBg:'{{ Session('flash_type') == 'success' ? '#e69a2a' : '#e69a2a'}}',
			icon: '{{Session('flash_type')}}',
			hideAfter: 3500, 
			stack: 6
		});
	</script>
